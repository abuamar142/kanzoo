    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Audio Players and Questions
          if (widget.audioData.audioFiles != null) ...[
            ...widget.audioData.audioFiles!.asMap().entries.map((entry) {
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (widget.audioData.questions != null &&
                        index < widget.audioData.questions!.length) ...[
                      const SizedBox(height: AppDimensions.spaceM),
                      Container(
                        width: double.infinity,
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'File audio tidak tersedia untuk materi ini.',
                      style: _scaledTextStyleWith(
                        AppTextStyles.bodyMedium,
                        color: AppColors.warning,
                      ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Tekan tombol play untuk mendengarkan audio. Gunakan tombol stop untuk menghentikan pemutaran.',
                    style: _scaledTextStyleWith(
                      AppTextStyles.caption,
                      color: AppColors.info,
                    ),
