...
class IstimaSection extends MaterialSection {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<IstimaSectionController>(
      init: IstimaSectionController(exercises, sectionId, exerciseType),
      builder: (controller) {
        return Obx(() {
  ...
  Widget _buildExerciseItem(
    IstimaSectionController controller,
    int index,
        ...
        child: Column(
          ...
          children: [
            ...
            if (exerciseType == 'matching') ...[
              ...
              // Completion exercise - show text field or selected answer
              if (isCompleted) ...[
                Container(
                  padding: const EdgeInsets.all(AppDimensions.paddingM),
                  decoration: BoxDecoration(
...
class IstimaSectionController extends GetxController {
  final List<AudioExercise> exercises;
  final String sectionId;
  final String exerciseType;
  ...
  IstimaSectionController(this.exercises, this.sectionId, this.exerciseType) {
