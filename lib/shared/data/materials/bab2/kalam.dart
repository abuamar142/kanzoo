...
class Bab2KalamData {
  static final List<MaterialSection> sections = [
    ...
    DialogSection([
      ...
      DialogLine(
        speaker: 'شَرِيْفٌ',
        text: 'هَلِ الْمَرَافِقُ الْمَدْرَسِيَّةُ فِي مَدْرَسَتِكَ كَامِلَةٌ؟',
      ),
      DialogLine(
        speaker: 'مُوسَى',
        text:
      ...
      DialogLine(speaker: 'شَرِيْفٌ', text: 'مَا هِيَ ؟'),
      DialogLine(
        speaker: 'مُوسَى',
        text:
...
MaterialContent get kalamBab2Content =>
    MaterialContent(Bab2KalamData.sections);
