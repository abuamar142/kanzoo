...
SimpleMaterialContent get mahfudzotGeneralContent => SimpleMaterialContent([
  SectionThree(
    ...
    wordPairs: [
      ...
      ['Kejujuran itu penyelamat', 'الصِّدْقُ مُنْجَاةٌ'],
      ['Amanah adalah puncak akhlak', 'الأَمَانَةُ رَأْسُ الأَخْلَاقِ'],
      ['Dusta menghancurkan kepercayaan', 'الكَذِبُ يَهْدِمُ الثِّقَّةَ'],
      [
      ...
      ['Adab lebih utama daripada ilmu', 'الأَدَبُ قَبْلَ العِلْمِ'],
      [
